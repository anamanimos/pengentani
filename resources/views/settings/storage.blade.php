...
@section('page_title')
    Monitoring & Pengaturan Cloudflare R2 <span class="text-gray-500 fw-semibold fs-7 ms-2">(Media Cloud Storage)</span>
@endsection
...
<div class="app-content flex-column-fluid pb-15">
    <div class="app-container container-fluid">
        ...
        <div class="row g-7">
            <!-- Monitoring Dashboard R2 Header Card -->
            <div class="col-12">
                    ...
                    <div class="card card-flush shadow-sm h-100">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="form-text fs-9 text-gray-500">Domain publik R2 (pub-xxx.r2.dev) atau Custom Domain yang sudah terhubung dengan Bucket.</div>
                            </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="d-flex flex-column gap-3 mb-6">
                            <div class="d-flex justify-content-between align-items-center p-3 bg-light rounded-3 border">
                                <span class="fs-8 fw-bold text-gray-600">Sisa File di Server:</span>
