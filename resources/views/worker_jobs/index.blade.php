...
@section('page_actions')
    ...
    <form action="{{ route('worker-jobs.index') }}" method="GET" class="m-0 d-flex align-items-center me-3">
...
<div class="position-relative" id="spreadsheet-wrapper">
    ...
    <div class="spreadsheet-fs-header d-none">
        ...
        <div class="d-flex align-items-center gap-2">
            <form action="{{ route('worker-jobs.index') }}" method="GET" class="m-0 d-flex align-items-center">
                @if(request('pertanian_id'))
                    <input type="hidden" name="pertanian_id" value="{{ request('pertanian_id') }}">
                @endif
            </form>
