                ...
                <tbody class="text-gray-600 fw-semibold">
                    ...
                    <tr>
                        ...
                        <td class="text-end text-nowrap">
                            <a href="{{ route('income-categories.edit', $category) }}" class="btn btn-icon btn-light-warning btn-sm me-1" title="Edit">
                                <i class="ki-duotone ki-pencil fs-2"><span class="path1"></span><span class="path2"></span></i>
                            </a>
                            <form action="{{ route('income-categories.destroy', $category) }}" method="POST" class="d-inline delete-form">
                                @csrf
                                @method('DELETE')
...
<script>
    $(document).ready(function () {
        $('#kt_table_income_categories').DataTable({
            "language": {
